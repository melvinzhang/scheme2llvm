...
Issue: libgc still fails as libgc is scanning 64bit points but we cast pointers to 32bits.
  Solution: Change representation from uint to ulong. Works!

Issue: LLVM IR generated by bootstrapped compiler is not exactly the same as interpreted compiler
